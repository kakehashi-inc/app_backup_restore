...
| powershell_profile | PowerShell プロファイル | Windows | 1     | `%USERPROFILE%\Microsoft.PowerShell_profile.ps1`                      | -        | -        |
...
* Windows:
  ...
  * `%USERPROFILE%\.dbgate\settings.json`
  * `%USERPROFILE%\.dbgate\connections.jsonl`
* macOS:

  * `~/.dbgate/settings.json`
  * `~/.dbgate/connections.jsonl`
* Linux:
