export default {
    ...
    noExtensionsFound: '拡張機能が見つかりませんでした',
    noExtensionsFoundInWSL: 'WSL内に拡張機能が見つかりませんでした',
    restoreSelectedSuccess: '選択した項目の復元が完了しました',
    restoreSelectedFailed: '選択した項目の復元に失敗しました',
    restoreExtensionsInWSLSuccess: 'WSL内の拡張機能の復元が完了しました',
    restoreExtensionsInWSLFailed: 'WSL内の拡張機能の復元に失敗しました',
    appNotInstalled: 'アプリケーションがインストールされていないか、PATHに追加されていません',
