...
export const VS_CODE_DEFS: readonly VSCodeDef[] = [
    ...
    },
    {
        ...
        darwinAppName: 'Antigravity IDE.app',
        settingsPaths: {
            win32: '%APPDATA%\\Antigravity IDE',
            darwin: '~/Library/Application Support/Antigravity IDE',
            linux: '~/.config/Antigravity IDE',
        },
        files: {
            win32: [
                '%APPDATA%\\Antigravity IDE\\User\\keybindings.json',
            ...
            linux: [
                '~/.config/Antigravity IDE/User/keybindings.json',
